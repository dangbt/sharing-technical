    ...
    <Layout {...props}>
      <div className="profile_container">
        <aside className="flex flex-row items-center justify-around profile-card">
          <header>
            <a href="#">
              <img src="http://victory-design.ru/sandbox/codepen/profile_card/avatar.svg" alt="" />
            </a>
          ...
          <div className="flex flex-col items-center justify-center h-full left_container">
